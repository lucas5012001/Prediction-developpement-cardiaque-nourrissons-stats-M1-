...
features = setdiff(colnames(data),c("PMA","Day","ID"))
#################################################
#grille de recherche des hyperparametres
hyper_grid <- expand.grid(
  mtry       = seq(2, length(features), by = 1),
...
plot(hyper_grid$mtry,hyper_grid$MSE,xlab = "mtry", ylab = "MSE", main = "optimisation random_forest_GA")
